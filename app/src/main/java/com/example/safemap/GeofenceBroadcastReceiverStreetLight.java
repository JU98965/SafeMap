...
public class GeofenceBroadcastReceiverStreetLight extends BroadcastReceiver {
...
//            // 데이터를 Activity로 전달하기 위해 Broadcast를 전송합니다.
            ...
            broadcastIntent.putExtra("keyStreetLight", 1);
            ...
            Intent broadcastIntent = new Intent();
            broadcastIntent.setAction("your_broadcast_action");
            broadcastIntent.putExtra("keyStreetLight", 2);
            context.sendBroadcast(broadcastIntent);
        }
